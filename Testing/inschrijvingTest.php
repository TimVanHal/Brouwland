...
<html>
    ...
    <body>
        <?php
            ...
            $query = mysql_query("SELECT * FROM team ORDER BY id DESC LIMIT 1")  or die(mysql_error());
            ...
            print "</br><h3>Einde inschrijving 1</h3>";
            print "</br>";
            ...
            print "</br><h3>Einde inschrijving 2</h3>";
            print "</br>";
            
            //-----------------------------------------------------------------------------------------------
            $query = mysql_query("SELECT * FROM cursussen WHERE teamId='$teamId'")  or die(mysql_error());
            $data = mysql_fetch_array($query);
            
            print "<h1>Informatie reservekapitein</h1>";
            
            $id++;
            print "<b>Aantal: </b><b id = $id>" . $data['aantal'] . "</b></br>";
            $id++;
            print "<b>Datum: </b><b id = $id>" . $data['datum'] . "</b></br>";
            
            print "</br><h3>Einde inschrijving 3</h3>";
            print "</br>";
        ?>
    </body>
</html>