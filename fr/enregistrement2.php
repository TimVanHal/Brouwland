...
<html>
    ...
    <body>
        ...
        <form method="POST" name="inschrijven2">
            ...
            <div class="panel-heading">Membres de l'equipe</div>
                <div class="panel-body">
                    <div class="panel panel-info">
                        <div class="panel-heading">Membre 1 (Capitain)</div>
                        <div class="panel-body">
                            <div class="input-group col-xs-2">
                                <label>Prénom:</label>
                                <input type="text" class="form-control" placeholder="Prénom" id="voornaamKapitein" name="voornaam1" required>
                            </div>
                            <div class="input-group col-xs-2">
                                <label>Nom de famille:</label>
                                <input type="text" class="form-control" placeholder="Nom de famille" id="achternaamKapitein" name="achternaam1" required>
                            </div>
                            <div class="input-group">
                                <label for="adresKapitein" class="control-label">Nom de rue + numéro:</label>
                                <div>
                                    <div class="form-inline">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="straatKapitein" placeholder="Rue" name="straat1" required>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <label for="gemeenteKapt" class="control-label">Ville:</label>
                                <div>
                                    <div class="form-group col-xs-4">
                                        <input type="text" class="form-control" id="postcodeKapitein" placeholder="Code postal" name="postcode1" required>
                                    </div>
                                    <div class="form-group col-xs-8">
                                        <input type="text" class="form-control" placeholder="Ville" id="gemeenteKapitein" name="gemeente1" required>
                                    </div>
                                </div>
                            </div>
                            <div class="input-group col-xs-2">
                            ...
                            <div class="input-group col-xs-2">
                                ...
                                <input type="text" class="form-control" placeholder="Numéro de téléphone" id="telefoonKapitein" name="telefoon1" required>
                            </div>
                            <label>Sexe:</label>
                                <input type="radio" name="geslacht1" id="geslachtKapitein-0" value="m" required>Homme
                                <input type="radio" name="geslacht1" id="geslachtKapitein-1" value="v">Femme
                            <div class="input-group col-xs-2">
                                <label>E-mail:</label>
                            ...
                            <div class="input-group col-xs-2">
                                <input name="paswoord1" id="accPassword" type="password" class="form-control" placeholder="Mot de passe" required>
                            ...
                            <br><strong>L'e-mail du capitain sera être utilise pour le contact et comme log-in.</strong>
                        </div>
                    </div>
                    <div class="panel panel-info">
                        <div class="panel-heading">Membre 2 (Capitain Réserve)</div>
                        <div class="panel-body">
                            <div class="input-group col-xs-2">
                                <label>Prénom:</label>
                                <input type="text" class="form-control" placeholder="Prénom" id="voornaamReserve" name ="voornaam2" required>
                            </div>
                            <div class="input-group col-xs-2">
                                <label>Nom de famille:</label>
                                <input type="text" class="form-control" placeholder="Nom de famille" id="achternaamReserve" name="achternaam2" required>
                            </div>
                            <div class="input-group">
                                <label for="adresReserve" class="control-label">Nom de Rue + nr:</label>
                                <div class="col-xs-0">
                                    <div class="form-inline">
                                        <div class="form-group col-xs-9">
                                            <input type="text" class="form-control" id="stratReserve" placeholder="Rue" name="straat2" required>
                                        </div>
                            ...
                            <div class="input-group">
                                <label for="gemeenteRes" class="control-label">Ville:</label>
                                <div class="col-xs-0">
                                    <div class="form-group col-xs-4">
                                        <input type="text" class="form-control" id="postcodeReserve" placeholder="Code postal" name="postcode2" required>
                                    </div>
                                    <div class="form-group col-xs-8">
                                        <input type="text" class="form-control" placeholder="Ville" id="gemeenteReserve" name="gemeente2" required>
                                    </div>
                                </div>
                            </div>
                            <div class="input-group col-xs-2">
                                <label>Pays:</label>
                                <select id="landReserve" class="form-control col-xs-2" required>
                                    <option value="">Choissisez votre pays</option>
                                    <option value="BE">België/Belgique</option>
                                    <option value="DE">Deutschland</option>
                                    <option value="FR">France</option>
                            ...
                            <div class="input-group col-xs-2">
                                <label>Numéro de téléphone:</label>
                                <input type="text" class="form-control" placeholder="Numéro de téléphone" id="telefoonReserve" name="telefoon2" required>
                            </div>
                            <div class="input-group col-xs-2">
                                <label>E-mail:</label>
                            ...
                            <label>Sexe:</label>
                                <input type="radio" name="geslacht2" id="geslachtReserve-0" value="m" required>Homme
                                <input type="radio" name="geslacht2" id="geslachtReserve-1" value="v">Femme
                        </div>
                    </div>
                    <div class="panel panel-info">
                        ...
                        <div id="memberThree" class="panel-collapse collapse" aria-labelledby="headingThree">
                            <div class="panel-body">
                                <div class="input-group col-xs-2">
                                    <label>Prénom:</label>
                                    <input type="text" class="form-control 3" placeholder="Prénom" id="voornaam3" name="voornaam3">
                                </div>
                                <div class="input-group col-xs-2">
                                    <label>Nom de famille:</label>
                                    <input type="text" class="form-control 3" placeholder="Nom de famille" id="achternaam3" name="achternaam3">
                                </div>
                                <div class="input-group col-xs-2">
                                    <label>E-mail:</label>
                                ...
                                <label>Sexe:</label>
                                    <input type="radio" name="geslacht3" id="geslachtTeamlid3-0" value="m">Homme
                                    <input type="radio" name="geslacht3" id="geslachtTeamlid3-1" value="v">Femme
                            </div>
                            <script>
                        ...
                        <div class="panel-footer">*: Optionnel </div>
                    </div>
                    <div class="panel panel-info">
                        ...
                        <div id="memberFour" class="panel-collapse collapse" aria-labelledby="headingFour">
                            <div class="panel-body">
                                <div class="input-group col-xs-2">
                                    <label>Prénom:</label>
                                    <input type="text" class="form-control 4" placeholder="Prénom" id="voornaam4" name="voornaam4">
                                </div>
                                <div class="input-group col-xs-2">
                                    <label>Nom de famille:</label>
                                    <input type="text" class="form-control 4" placeholder="Nom de famille" id="achternaam4" name="achternaam4">
                                </div>
                                <div class="input-group col-xs-2">
                                    <label>E-mail:</label>
                                ...
                                <label>Sexe:</label>
                                    <input type="radio" name="geslacht4" id="geslachtTeamlid4-0" value="m">Homme
                                    <input type="radio" name="geslacht4" id="geslachtTeamlid4-1" value="v">Femme
                            </div>
                            <script>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="memberFive" class="panel-collapse collapse" aria-labelledby="headingFive">
                            <div class="panel-body">
                                <div class="input-group col-xs-2">
                                    <label>Prénom:</label>
                                    <input type="text" class="form-control 5" placeholder="Prénom" id="voornaam5" name="voornaam5">
                                </div>
                                <div class="input-group col-xs-2">
                                    <label>Nom de famille:</label>
                                    <input type="text" class="form-control 5" placeholder="Nom de famille" id="achternaam5" name="achternaam5">
                                </div>
                                <div class="input-group col-xs-2">
                                    <label>E-mail:</label>
                                ...
                                <label>Sexe:</label>
                                    <input type="radio" name="geslacht5" id="geslachtTeamlid5-0" value="m">Homme
                                    <input type="radio" name="geslacht5" id="geslachtTeamlid5-1" value="v">Femme
                            </div>
                            <script>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="memberSix" class="panel-collapse collapse" aria-labelledby="headingSix">
                            <div class="panel-body">    
                                <div class="input-group col-xs-2">
                                    <label>Prénom:</label>
                                    <input type="text" class="form-control 6" placeholder="Prénom" id="voornaam6" name="voornaam6">
                                </div>
                                <div class="input-group col-xs-2">
                                    <label>Nom de famille:</label>
                                    <input type="text" class="form-control 6" placeholder="Nom de famille" id="achternaam6" name="achternaam6">
                                </div>
                                <div class="input-group col-xs-2">
                                    <label>E-mail:</label>
                                ...
                                <label>Sexe:</label>
                                    <input type="radio" name="geslacht6" id="geslachtTeamlid6-0" value="m">Homme
                                    <input type="radio" name="geslacht6" id="geslachtTeamlid6-1" value="v">Femme
                            </div>
                            <script>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="memberSeven" class="panel-collapse collapse" aria-labelledby="headingSeven">
                            <div class="panel-body">    
                                <div class="input-group col-xs-2">
                                    <label>Prénom:</label>
                                    <input type="text" class="form-control 7" placeholder="Prénom" id="voornaam7" name="voornaam7">
                                </div>
                                <div class="input-group col-xs-2">
                                    <label>Nom de famille:</label>
                                    <input type="text" class="form-control 7" placeholder="Nom de famille" id="achternaam7" name="achternaam7">
                                </div>
                                <div class="input-group col-xs-2">
                                    <label>E-mail:</label>
                                    <input type="email" class="form-control 7" placeholder="E-mail" id="email7" name="email7">
                                </div>
                                <label>Sexe:</label>
                                    <input type="radio" name="geslacht7" id="geslachtTeamlid7-0" value="m">Homme
                                    <input type="radio" name="geslacht7" id="geslachtTeamlid7-1" value="v">Femme
                            </div>
                            <script>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="memberEight" class="panel-collapse collapse" aria-labelledby="headingEight">
                            <div class="panel-body">
                                <div class="input-group col-xs-2">
                                    <label>Prénom:</label>
                                    <input type="text" class="form-control 8" placeholder="Prénom" id="voornaam8" name="voornaam8">
                                </div>
                                <div class="input-group col-xs-2">
                                    <label>Nom de famille:</label>
                                    <input type="text" class="form-control 8" placeholder="Nom de famille" id="achternaam8" name="achternaam8">
                                </div>
                                <div class="input-group col-xs-2">
                                    <label>E-mail:</label>
                                    <input type="email" class="form-control 8" placeholder="E-mail" id="email8" name="email8">
                                </div>
                                <label>Sexe:</label>
                                    <input type="radio" name="geslacht8" id="geslachtTeamlid8-0" value="m">Homme
                                    <input type="radio" name="geslacht8" id="geslachtTeamlid8-1" value="v">Femme
                            </div>
                            <script>
