    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../nl/admin/toewijzenKeurder.php" class="language">NL</a></div>
        ...
        <form method="POST">
            <div class="panel panel-default">
                <div class="panel-heading">Assigner les Juges</div>
                <div class="panel-body">
                    Sélectionnez un juge et sa bière respective pour évaluer.
                    <div id="keurderSelect" class="input-group col-xs-2">
                        <label>Juge:</label>
                        <select id="keurder" name="keurder" class="form-control col-xs-2">
                            <option value="">Sélectionnez juge</option>
                            <?php
                    ...
                    <div id="bierSelect" class="input-group col-xs-2">
                        ...
                        <select id="bier" name="bier" class="form-control col-xs-2">
                            <option value="">Sélectionnez bière</option>
                            <?php
                    ...
                    <div id="dienIn">
                        <input type="submit" value="Assigner" class="btn btn-primary">
                    </div>
                </div>
            </div>
        </form>
