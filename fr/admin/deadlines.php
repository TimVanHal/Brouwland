...
<html>
    ...
    <body>
        ...
        <form method="POST">
            ...
            <div class="panel-heading">Réglez les deadlines</div>
                <div class="panel-body">
                    <strong>Dates actuelles:</strong><br>
                <br><label>Début enregistrement:</label>
                ...
                <br><label>Fin enregistrement:</label>
                ...
                <br><label>Début évaluations:</label>
                ...
                <br><label>Fin évaluations:</label>
