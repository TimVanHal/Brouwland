...
<html>
    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../nl/admin/aanpassenKeurder.php" class="language">NL</a></div>
                            <div class="item"><a href="../../en/admin/editJudge.php" class="language">ENG</a></div>
        ...
        <form method="POST">
            ...
            <div class="panel-heading">Informations juré</div>
                <div class="panel-body">
                    <label>Prénom: </label> 
                        ...
                        <div class="input-group col-xs-2" id="editVoornaam" style="display:none">
                            <input type="text" class="form-control" placeholder="Prénom" id="newVoornaam" name="voornaam">
                        </div>
                        <span id="editBtn1">
                    ...
                    <br><label>Nom: </label>
                        ...
                        <div class="input-group col-xs-2" id="editAchternaam" style="display:none">
                            <input type="text" class="form-control" placeholder="Nom" id="newAchternaam" name="achternaam">
                        </div>
                        <span id="editBtn2">
                    ...
                    <br><label>Adresse: </label> 
                        ...
                        <div class="form-inline" id="editAdres" style="display:none">
                            <div class="form-group col-xs-9">
                                <input type="text" class="form-control" id="newStraat" placeholder="Rue" name="straat">
                            </div>
                    ...
                    <br><label>Commune: </label> 
                        ...
                        <div class="form-inline" id="editGemeente" style="display:none">
                            <div class="form-group col-xs-3">
                                <input type="number" class="form-control" id="newPostcode" placeholder="Code postal" name="postcode">
                            </div>
                            <div class="form-group col-xs-9">
                                <input type="text" class="form-control" id="newGemeente" placeholder="Commune" name="gemeente">
                            </div>
                        </div>
                        <span id="editBtn4">
