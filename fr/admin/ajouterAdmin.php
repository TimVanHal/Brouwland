                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../nl/admin/adminToevoegen.php" class="language">NL</a></div>
                            <div class="item"><a href="../../en/admin/addAdmin.php" class="language">ENG</a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel-heading">Ajouter un admin</div>
                <div class="panel-body">
                    ...
                    <div class="input-group col-xs-2">
                        ...
                        <input id="password" class="form-control" name="paswoord" type="password" placeholder="Paswoord" required>
                    </div>
                </div>
            </div>
            <div id="dienIn">
