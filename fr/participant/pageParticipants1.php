...
<html>
    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../nl/deelnemer/deelnemerspagina1.php" class="language">NL</a></div>
        ...
        <form method="POST">
            ...
            <div class="panel-heading">Membres du team</div>
                <div class="panel-body">
                            ...
                            <div class="panel-body">
                                <label>Prénom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editVoornaamKapitein" style="display:none">
                                        <input type="text" class="form-control" placeholder="Prénom" id="newVoornaamKapitein" name="voornaam1">
                                    </div>
                                    <span id="editBtn1">
                                ...
                                <br><label>Nom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editAchternaamKapitein" style="display:none">
                                        <input type="text" class="form-control" placeholder="Nom" id="newAchternaamKapitein" name="achternaam1">
                                    </div>
                                    <span id="editBtn2">
                                ...
                                <br><label>Adresse: </label> 
                                    ...
                                    <div class="form-inline" id="editAdresKapitein" style="display:none">
                                        <div class="form-group col-xs-9">
                                            <input type="text" class="form-control" id="newStraatKapitein" placeholder="Rue" name="straat1">
                                        </div>
                                ...
                                <br><label>Commune: </label> 
                                    ...
                                    <div class="form-inline" id="editGemeenteKapitein" style="display:none">
                                        <div class="form-group col-xs-3">
                                            <input type="number" class="form-control" id="newPostcodeKapitein" placeholder="Code Postal" name="postcode1">
                                        </div>
                                        <div class="form-group col-xs-9">
                                            <input type="text" class="form-control" id="newGemeenteKapitein" placeholder="Commune" name="gemeente1">
                                        </div>
                                    </div>
                                    <span id="editBtn4">
                                ...
                                <br><label>Numéro de téléphone: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editTelefoonNrKapitein" style="display:none">
                                        <input type="text" class="form-control" placeholder="Téléphone" id="newTelefoonNrKapitein" name="telefoon1">
                                    </div>
                                    <span id="editBtn6">
                                ...
                                <br><label>Sexe: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editGeslachtKapitein" style="display:none">
                                        <input type="radio" name="geslacht1" id="geslachtKapitein-0" value="m">Homme
                            ...
                            <div class="panel-body">
                                <label>Prénom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editVoornaamReserve" style="display:none">
                                        <input type="text" class="form-control" placeholder="Prénom" id="newReserveKapitein" name="voornaam2">
                                    </div>
                                    <span id="editBtn9">
                                ...
                                <br><label>Nom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editAchternaamReserve" style="display:none">
                                        <input type="text" class="form-control" placeholder="Nom" id="newAchternaamReserve" name="achternaam2">
                                    </div>
                                    <span id="editBtn10">
                                ...
                                <br><label>Adresse: </label> 
                                    ...
                                    <div class="form-inline" id="editAdresReserve" style="display:none">
                                        <div class="form-group col-xs-9">
                                            <input type="text" class="form-control" id="newStraatReserve" placeholder="Rue" name="straat2">
                                        </div>
                                        <div class="form-group col-xs-3">
                                ...
                                <br><label>Commune: </label> 
                                    ...
                                    <div class="form-inline" id="editGemeenteReserve" style="display:none">
                                        <div class="form-group col-xs-3">
                                            <input type="number" class="form-control" id="newPostcodeReserve" placeholder="Code postal" name="postcode2">
                                        </div>
                                        <div class="form-group col-xs-9">
                                            <input type="text" class="form-control" id="newGemeenteReserve" placeholder="Commune" name="gemeente2">
                                        </div>
                                    </div>
                                    <span id="editBtn12">
                                ...
                                <br><label>Numéro de téléphone: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editTelefoonNrReserve" style="display:none">
                                        <input type="text" class="form-control" placeholder="Téléphone" id="newTelefoonNrReserve" name="telefoon2">
                                    </div>
                                    <span id="editBtn14">
                                ...
                                <br><label>Sexe: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editGeslachtReserve" style="display:none">
                                        <input type="radio" name="geslacht2" id="geslachtReserve-0" value="m">Homme
                            ...
                            <div class="panel-body">
                                <label>Prénom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editVoornaamTeamlid3" style="display:none">
                                        <input type="text" class="form-control" placeholder="Prénom" id="newTeamlid3Kapitein" name="voornaam3">
                                    </div>
                                    <span id="editBtn17">
                                ...
                                <br><label>Nom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editAchternaamTeamlid3" style="display:none">
                                        <input type="text" class="form-control" placeholder="Nom" id="newAchternaamTeamlid3" name="achternaam3">
                                    </div>
                                    <span id="editBtn18">
                            ...
                            <div class="panel-body">
                                <label>Prénom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editVoornaamTeamlid4" style="display:none">
                                        <input type="text" class="form-control" placeholder="Prénom" id="newTeamlid4Kapitein" name="voornaam4">
                                    </div>
                                    <span id="editBtn21">
                                ...
                                <br><label>Nom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editAchternaamTeamlid4" style="display:none">
                                        <input type="text" class="form-control" placeholder="Nom" id="newAchternaamTeamlid4" name="achternaam4">
                                    </div>
                                    <span id="editBtn22">
                            ...
                            <div class="panel-body">
                                <label>Prénom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editVoornaamTeamlid5" style="display:none">
                                        <input type="text" class="form-control" placeholder="Prénom" id="newTeamlid5Kapitein" name="voornaam5">
                                    </div>
                                    <span id="editBtn25">
                                ...
                                <br><label>Nom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editAchternaamTeamlid5" style="display:none">
                                        <input type="text" class="form-control" placeholder="Nom" id="newAchternaamTeamlid5" name="achternaam5">
                                    </div>
                                    <span id="editBtn26">
                            ...
                            <div class="panel-body">
                                <label>Prénom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editVoornaamTeamlid6" style="display:none">
                                        <input type="text" class="form-control" placeholder="Prénom" id="newTeamlid6Kapitein" name="voornaam6">
                                    </div>
                                    <span id="editBtn29">
                                ...
                                <br><label>Nom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editAchternaamTeamlid6" style="display:none">
                                        <input type="text" class="form-control" placeholder="Nom" id="newAchternaamTeamlid6" name="achternaam6">
                                    </div>
                                    <span id="editBtn30">
                            ...
                            <div class="panel-body">
                                <label>Prénom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editVoornaamTeamlid7" style="display:none">
                                        <input type="text" class="form-control" placeholder="Prénom" id="newTeamlid7Kapitein" name="voornaam7">
                                    </div>
                                    <span id="editBtn33">
                                ...
                                <br><label>Nom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editAchternaamTeamlid7" style="display:none">
                                        <input type="text" class="form-control" placeholder="Nom" id="newAchternaamTeamlid7" name="achternaam7">
                                    </div>
                                    <span id="editBtn34">
                            ...
                            <div class="panel-body">
                                <label>Prénom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editVoornaamTeamlid8" style="display:none">
                                        <input type="text" class="form-control" placeholder="Prénom" id="newTeamlid8Kapitein" name="voornaam8">
                                    </div>
                                    <span id="editBtn37">
                                ...
                                <br><label>Nom: </label> 
                                    ...
                                    <div class="input-group col-xs-2" id="editAchternaamTeamlid8" style="display:none">
                                        <input type="text" class="form-control" placeholder="Nom" id="newAchternaamTeamlid8" name="achternaam8">
                                    </div>
                                    <span id="editBtn38">
                    ...
                    <div id="voegToe" style="display:none">
                        <button type="button" onclick="location.href='/fr/participant/membre.php'">Clickez ici pour ajouter un membre.</button>
                    </div>
                        ...
                        <div id="password" class="panel-collapse collapse" aria-labelledby="headingNine">
                            <div class="panel-body">
                                ...
                                <div class="input-group col-xs-2">
                                    <input name="paswoord1" id="accPassword" type="password" class="form-control" placeholder="Mot de passe">
                                ...
                                <label>Mot de pass nouveau:</label>
                                <div class="input-group col-xs-2">
                                    <input name="paswoord2" id="newPassword" type="password" class="form-control" placeholder="Mot de passe">
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-eye-open"></span></span>
                                    <script>
                                        $(".glyphicon-eye-open").on("click", function() {
