...
<html>
    ...
    <body>
        ...
        <div id="wrap">
            <div id="main">
                <div class="container_16">
                    <div class="grid_16">
                        <header><a href="#">
                                <div class="logo-fr">Brouwland Biercompetitie</div>
                            </a></header>
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../en/contender/newMember.php" class="language">ENG</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="http://www.mijnbier.be/nl/competition-directives">About</a></li>
        ...
        <form method="POST">
            ...
            <div class="panel-heading">Ajoutez votre membre</div>
                <div class="panel-body">
                    <div class="input-group col-xs-2">
                        <label>Prénom:</label>
                        <input type="text" class="form-control" placeholder="Prénom" id="voornaam" name="newVoornaam" required>
                    </div>
                    <div class="input-group col-xs-2">
                        <label>Nom:</label>
                        <input type="text" class="form-control" placeholder="Nom" id="achternaam" name="newAchternaam" required>
                    </div>
                    <div class="input-group col-xs-2">
                        <label>E-mail:</label>
                    ...
                    <label>Sexe:</label>
                        <input type="radio" name="newGeslacht" id="geslacht-0" value="m" required>Homme
                        <input type="radio" name="newGeslacht" id="geslacht-1" value="v">Femme
                </div>
            </div>
            <div id="dienIn">
