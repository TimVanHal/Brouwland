                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../en/judge/evaluation1.php" class="language">ENG</a></div>
                ...
                <div class="panel-body">
                        ...
                        <div id="memberOne" class="panel-collapse collapse" aria-labelledby="headingOne">
                            <div class="panel-body">
                                <div class="input-group">
                                    ...
                                    <br><input type="radio" name="presentatiecorrectheid" id="presentatiecorrectheid-1" value="0" onClick="enableOptions();calcPoints();">Niet correct
                                </div>
                                <div class="input-group" id="checkBoxes">
                                    <br><input onClick="calcPoints()" type="checkbox" name="presentatieFles" id="presentatie-1" value="1" disabled>Niet correct: Fles
                                    <br><input type="checkbox" name="presentatieVulhoogte" onClick="calcPoints()" id="presentatie-2" value="1" disabled>Niet correct: Vulhoogte
                                    <br><input type="checkbox" name="presentatieUiterlijk" onClick="calcPoints()" id="presentatie-3" value="1" disabled>Niet correct: Uiterlijke kenmerken
                                </div>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="memberTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
                            <div class="panel-body">
                                <input type="radio" name="koolzuur" id="koolzuur-0" value="geen" required>Geen
                                <br><input type="radio" name="koolzuur" id="koolzuur-1" value="weinig">Weinig
                                <br><input type="radio" name="koolzuur" id="koolzuur-2" value="correct">Correct
                                <br><input type="radio" name="koolzuur" id="koolzuur-3" value="overschuimend">Overschuimend
                                <br><input type="radio" name="koolzuur" id="koolzuur-4" value="spuitend">Spuitend
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="memberThree" class="panel-collapse collapse" aria-labelledby="headingThree">
                            <div class="panel-body">
                                <input type="radio" name="helderheid" id="helderheid-0" value="2" required>Correct volgens type
                                <br><input type="radio" name="helderheid" id="helderheid-1" value="0">Niet correct
                                <br><br><strong>Extra:</strong>
                                <br><input type="checkbox" name="helderheidBriljant" id="helderheidExtra-0" value="briljant ">Briljant
                                <br><input type="checkbox" name="helderheidHelder" id="helderheidExtra-1" value="helder ">Helder
                                <br><input type="checkbox" name="helderheidTweeschijn" id="helderheidExtra-2" value="tweeschijn ">Tweeschijn
                                <br><input type="checkbox" name="helderheidMistig" id="helderheidExtra-3" value="mistig ">Mistig
                                <br><input type="checkbox" name="helderheidMelk" id="helderheidExtra-4" value="melkachtig ">Melkachtig
                                <br><input type="checkbox" name="helderheidTroebel" id="helderheidExtra-5" value="troebel">Troebel
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="memberFour" class="panel-collapse collapse" aria-labelledby="headingFour">
                            <div class="panel-body">
                                <input type="radio" name="schuimkraag" id="schuimkraag-0" value="stabiel" required>Stabiel blijvend
                                <br><input type="radio" name="schuimkraag" id="schuimkraag-1" value="inzakkend">Langzaam inzakkend tot blijvend laagje
                                <br><input type="radio" name="schuimkraag" id="schuimkraag-2" value="neerslaand">Neerslaand
                                <br><input type="radio" name="schuimkraag" id="schuimkraag-3" value="cola">Cola-achtig
                                <br><input type="radio" name="schuimkraag" id="schuimkraag-4" value="geen">Geen schuim
                                <br><br><strong>Extra:</strong>
                                <br><input type="checkbox" name="schuimkraagOngelijkmatig" id="schuimkraagExtra-0" value="ongelijkmatig ">Ongelijkmatige schuim
                                <br><input type="checkbox" name="schuimkraagMousse" id="schuimkraagExtra-1" value="mousse ">Mousse
                                <br><input type="checkbox" name="schuimkraagRomig" id="schuimkraagExtra-2" value="romig ">Romig
                                <br><input type="checkbox" name="schuimkraagGlasplakkend" id="schuimkraagExtra-3" value="glasplakkend">Glasplakkend
