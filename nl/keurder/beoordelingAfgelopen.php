    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../fr/jure/evaluationsFini.php" class="language">FR</a></div>
                            <div class="item"><a href="../../en/judge/registrationExpired.php" class="language">ENG</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form>
            <div class="panel panel-default">
                <div class="panel-heading">De beoordelingen zijn afgelopen.</div>
                <div class="panel-body">
                    De periode om uw beoordelingen door te geven is afgelopen.
                </div>
            </div>
        </form>
    </body>
