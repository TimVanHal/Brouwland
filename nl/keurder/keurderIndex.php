                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../fr/jure/jureIndex.php" class="language">FR</a></div>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="#">Keurder index</a></li>
                    <li><a href="http://www.mijnbier.be/nl/competitie-richtlijnen">About</a></li>
                    <li><a href="beoordeling0.php">Beoordeling</a></li>
                    <li><a href="../logout.php">Afmelden</a></li>
                </ul>
            </div>
        </nav>
        <div class="panel panel-default">
            <div class="panel-heading">Index Keurder</div>
            <div class="panel-body">
                Wat wilt u doen?
                <ul id="opties">
                    <li><a href="beoordeling0.php">Beoordeling starten.</a></li>
                    <li><a href="keurderpagina.php">Gegevens/paswoord bijwerken.</a></li>
                </ul>
            </div>
        </div>
    </body>
