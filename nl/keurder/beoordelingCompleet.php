...
<html>
    ...
    <body>
        ...
        <form>
            ...
            <div class="panel-heading">U heeft alles ingevuld<br>U gaat zometeen terug naar de bierkeuze.</div>
        </form>
        <script>
            var delay = 5000; //Your delay in milliseconds

            setTimeout(function(){ window.location = 'beoordeling0.php'; }, delay);
        </script>
    </body>
</html>