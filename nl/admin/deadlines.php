...
<html>
    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../en/admin/deadlines.php" class="language">ENG</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form method="POST">
            ...
            <div class="panel-heading">Stel de deadline data in</div>
                <div class="panel-body">
                    <strong>Huidige data:</strong><br>
                <br><label>Start inschrijvingen:</label>
                ...
                <br><label>Einde inschrijvingen:</label>
                ...
                <br><label>Start beoordelingen:</label>
                ...
                <br><label>Einde beoordelingen:</label>
                ...
                <br><label>Deadline binnenbrengen bier:</label>
