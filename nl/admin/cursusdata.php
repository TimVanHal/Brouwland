...
<html>
    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../en/admin/coursedate.php" class="language">ENG</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form method="POST">
            ...
            <div class="panel-heading">Stel de cursusdata in</div>
                <div class="panel-body">
                    <label>Huidige data:</label> 
                    <ul>
                        <?php
                            ...
                            foreach ($storeArray as $datum){
                                echo "<li>
                                    ...
                                    <div class='input-group col-xs-2' id='editDatum".$count."' style='display:none'>
                                        <input type='date' class='form-control' placeholder='Datum' id='newDatum".$count."' name='datum".$count."'>
                                    </div>
                    ...
                    <br>
                    <label>Datum toevoegen:</label>
                    <div class='input-group col-xs-2' id='newDatum'>
                        <input type='date' class='form-control' placeholder='Datum' id='newDatum' name='newDatum'>
                    </div>
                </div>
            </div>
            <div id="dienIn">
