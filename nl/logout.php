...
<?php
    ...
    $_SESSION['lang'] = "NL";
    include "../php/logout_function.php";
    logout_function();
?>
<html>
    <head>
    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../fr/logout.php" class="language">FR</a></div>
                            <div class="item"><a href="../en/logout.php" class="language">ENG</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form>
            ...
            <div class="panel-heading">U bent uitgelogd.<br>U wordt zo meteen terug doorverwezen naar de login pagina.</div>
        </form>
        <script>
