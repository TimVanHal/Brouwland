    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if($aardbeiGeur == '' || $aardbeiSmaak == '' || $ananasGeur == '' || $ananasSmaak == '' || $appelGeur == '' || $appelSmaak == '' || 
          ...
          $zoutigGeur == '' || $zoutigSmaak == '') {
            ...
            $query = "INSERT INTO smaakneutraal(aardbei, ananas, appel, bessen, caramel, fruitig, gebrand, kaneel, 
                    gistachtig, hogereAlcoholen, hoppig, koriander, kruidig, kruidnagel, melkzuur, graan, vanille, anijs, zoetig, zoutig, andere, waardeAndere) 
                    VALUES 
                    ('$aardbeiSmaak', '$ananasSmaak', '$appelSmaak', '$bosSmaak', '$caramelSmaak', '$fruitigSmaak', '$gebrandSmaak', '$gemberSmaak',
                    '$gistachtigSmaak', '$hogereAlcoholenSmaak', '$hoppigSmaak', '$korianderSmaak', '$kruidigSmaak', '$kummelSmaak', '$melkzuurSmaak',
                    '$moutigSmaak', '$sherrySmaak', '$zoethoutSmaak', '$zoetigSmaak', '$zoutigSmaak', '$waarneembareAndere', '$waarneembareAndereSmaak')";
            ...
            $query = "INSERT INTO geurneutraal(aardbei, ananas, appel, bessen, caramel, fruitig, gebrand, kaneel, 
                    gistachtig, hogereAlcoholen, hoppig, koriander, kruidig, kruidnagel, melkzuur, graan, vanille, anijs, zoetig, zoutig, andere, waardeAndere) 
                    VALUES 
                    ...
                    '$moutigGeur', '$sherryGeur', '$zoethoutGeur', '$zoetigGeur', '$zoutigGeur', '$waarneembareAndere', '$waarneembareAndereGeur')";
            mysql_query($query) or die ('Error updating' . mysql_error());
