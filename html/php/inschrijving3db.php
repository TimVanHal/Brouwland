<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if($_POST["gelezen"] == "0"){
            ...
            $query = "INSERT INTO team(naam, taal, category) VALUES ('$teamnaam', '$land', '$categorie')";
            mysql_query($query) or die ('Error updating' . mysql_error());
            $query2 = "INSERT INTO bier(teamId, soort, naam) SELECT id, '$typeBier', '$biernaam' FROM team ORDER BY id DESC LIMIT 1";
            mysql_query($query2) or die ('Error updating' . mysql_error());
            ...
            //hoofdkapitein
            $query = "INSERT INTO adres(straat, huisnummer, postcode, plaats, land) VALUES ('$straat1', '$huisnr1', '$postcode1','$gemeente1','$land1')";
            mysql_query($query) or die ('Error updating' . mysql_error());
            $query = "INSERT INTO teamkapitein(teamId, adresId, voornaam, naam, GSM, geslacht, email, paswoord, hoofdkapitein) SELECT '$teamid', id , '$voornaam1', '$achternaam1', '$telefoon1', '$geslacht1', '$email1', '$hash_paswoord', 1 FROM adres ORDER BY id DESC LIMIT 1";
            mysql_query($query) or die ('Error updating' . mysql_error());
            $query = "INSERT INTO users(email, paswoord, gebruiker) VALUES ('$email1', '$hash_paswoord', 1)";
            mysql_query($query) or die ('Error updating' . mysql_error());
            //reservekapitein
            $query2 = "INSERT INTO adres(straat, huisnummer, postcode, plaats, land) VALUES ('$straat2', '$huisnr2', '$postcode2','$gemeente2','$land2')";
            mysql_query($query2) or die ('Error updating' . mysql_error());
            $query2 = "INSERT INTO teamkapitein(teamId, adresId, voornaam, naam, GSM, geslacht, email, paswoord, hoofdkapitein) SELECT '$teamid', id , '$voornaam2', '$achternaam2', '$telefoon2', '$geslacht2', '$email2', '$hash_paswoord', 0 FROM adres ORDER BY id DESC LIMIT 1";
            mysql_query($query2) or die ('Error updating' . mysql_error());
            //lid 3
            ...
            if(!$voornaam3 == ''){
                ...
                $query3 = "INSERT INTO teamlid(teamId, voornaam, naam, geslacht, email) VALUES ($teamid, '$voornaam3', '$achternaam3', '$geslacht3', '$email3')";
                ...
                if(!$voornaam4 == ''){
                    ...
                    $query4 = "INSERT INTO teamlid(teamId, voornaam, naam, geslacht, email) VALUES ($teamid, '$voornaam4', '$achternaam4', '$geslacht4', '$email4')";
                    ...
                    if(!$voornaam5 == ''){
                        ...
                        $query5 = "INSERT INTO teamlid(teamId, voornaam, naam, geslacht, email) VALUES ($teamid, '$voornaam5', '$achternaam5', '$geslacht5', '$email5')";
                        ...
                        if(!$voornaam6 == ''){
                            ...
                            $query6 = "INSERT INTO teamlid(teamId, voornaam, naam, geslacht, email) VALUES ($teamid, '$voornaam6', '$achternaam6', '$geslacht6', '$email6')";
                            ...
                            if(!$voornaam7 == ''){
                                ...
                                $query7 = "INSERT INTO teamlid(teamId, voornaam, naam, geslacht, email) VALUES ($teamid, '$voornaam7', '$achternaam7', '$geslacht7', '$email7')";
                                ...
                                if(!$voornaam8 == ''){
                                    ...
                                    $query8 = "INSERT INTO teamlid(teamId, voornaam, naam, geslacht, email) VALUES ($teamid, '$voornaam8', '$achternaam8', '$geslacht8', '$email8')";
