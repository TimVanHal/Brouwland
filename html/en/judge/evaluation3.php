            ...
            <div class="panel-heading">Judging form</div>
                <div class="panel-body">
                    <div class="panel panel-info">
                        <div class="panel-heading">Flavor en smells</div>
                        <div class="panel-body">
                            <div class="input-group">
                                <table id="table">
                                    <tr>
                                        <th id="hoofding">Smell- & flavorassociation</th>
                                        <th colspan="4">Smell</th>
                                        <th colspan="4">Flavor</th>
                                    </tr>
                                    <tr>
                                        <td id="hoofding"><strong>Deviations - errors - Special</strong></td>
                                    ...
                                    <tr>
                                        <td id="hoofding">Acetaldehyde / green apples</td>
                                    ...
                                    <tr>
                                        <td id="hoofding">Butter / oil / soapy</td>
                                    ...
                                    <tr>
                                        <td id="hoofding">Dms / suger / boiled vegatables</td>
                                    ...
                                    <tr>
                                        <td id="hoofding">Phenols / medicinal / burned</td>
                                    ...
                                    <tr>
                                        <td id="hoofding">Oxidiced / cartboardlike / stale</td>
                                    ...
                                    <tr>
                                        <td id="hoofding">Grasslike / nutlike</td>
                                    ...
                                    <tr>
                                        <td id="hoofding">Solvent (ethylacetaat)</td>
                                    ...
                                    <tr>
                                        <td id="hoofding">Wort / resinous</td>
                                    ...
                                    <tr>
                                        <td id="hoofding">Sulphurous / sulfite</td>
                                    ...
                                    <tr>
                                        <td>Andere: <input type="text" name="afwijkingenAndere"></td>
                            ...
                            <br><br>
                            <div class="input-group">
                                <label class="control-label">Points smell & flavor:</label>
                                <div>
                                    <div class="form-inline">
                                        <div class="form-group col-xs-6">
                                            <input type="number" class="form-control" id="puntenGeur" placeholder="Smell" min="0" max="25" required>/25
                                        </div>
                                        <div class="form-group col-xs-6">
                                            <input type="number" class="form-control" id="puntensmaak" placeholder="Flavor" min="0" max="25" required>/15
                                        </div>
                                    </div>
                                </div>
                            </div>
