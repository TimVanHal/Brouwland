...
<html>
    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../en/registrationComplete.php" class="language">ENG</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form>
            ...
            <div class="panel-heading">U bent ingeschreven<br>U wordt zo meteen doorverwezen naar de login pagina.</div>
        </form>
        <script>
