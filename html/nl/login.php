        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="inschrijving1.php">Inschrijven</a></li>
                ...
                <form action="login.php" class="pure-form pure-form-aligned" method="POST" enctype="application/x-www-form-urlencoded">
                    <fieldset>
                            ...
                            <div class="pure-control-group">
                                    ...
                                    <input id="password" name="paswoord" type="password" placeholder="Paswoord">
                            </div>
                            Nog geen account? <a href="inschrijving1.php">Klik hier</a> om u in te schrijven voor de competitie!
                            <div class="pure-controls">
                                    <button type="submit" value="Login" class="btn btn-primary">Inloggen</button>
                            </div>
                    </fieldset>
                </form>
            </div>
