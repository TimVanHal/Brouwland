...
<html>
    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../nl/admin/aanpassenDeelnemer.php" class="language">NL</a></div>
                            <div class="item"><a href="../../en/admin/editContender.php" class="language">ENG</a></div>
        ...
        <form method="POST">
            ...
            <div class="panel-heading">Informations participant</div>
                <div class="panel-body">
                    <div class="panel panel-info">
                        ...
                        <div id="memberZero" class="panel-collapse collapse" aria-labelledby="headingZero">
                            ...
                            <br><label>Catégorie bière: </label>
                                ...
                                <div id="editCategory" class="input-group col-xs-2" style="display:none">
                                    <select id="newCategory" class="form-control col-xs-2" name="category">
                                        ...
                                        <option value="S">Meilleure bière students</option>
                                    </select>
                                </div>
                                <span id="editBtn43">
                    ...
                    <div id="voegToe" style="display:none">
                        <button type="button" onclick="location.href='/fr/admin/ajouterMembre.php'">Clickez ici pour ajouter un membre</button>
                    </div>
                    <?php
