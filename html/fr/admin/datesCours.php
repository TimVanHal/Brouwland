...
<html>
    ...
    <body>
        ...
        <form method="POST">
            ...
            <div class="panel-heading">Réglez les dates de cours</div>
                <div class="panel-body">
                            ...
                            foreach ($storeArray as $datum){
                                echo "<li>
                                    ...
                                    <div class='input-group col-xs-2' id='editDatum".$count."' style='display:none'>
                                        <input type='text' class='form-control' placeholder='Date' id='newDatum".$count."' name='datum".$count."'>
                                    </div>
                    ...
                    <div class='input-group col-xs-2' id='newDatum'>
                        <input type='text' class='form-control' placeholder='Date' id='newDatum' name='newDatum'>
                    </div>
                </div>
            </div>
            <div id="dienIn">
