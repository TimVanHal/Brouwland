                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../nl/beoordeling4.php" class="language">NL</a></div>
                            <div class="item"><a href="../../en/evaluation4.php" class="language">ENG</a></div>
                ...
                <div class="panel-body">
                    <div class="panel panel-info">
                        ...
                        <div id="memberOne" class="panel-collapse collapse" aria-labelledby="headingOne">
                            <div class="panel-body">
                                <br><input type="radio" name="doordrinkbaarheid" id="doordrinkbaarheid-0" value="5" required>Bon
                                <br><input type="radio" name="doordrinkbaarheid" id="doordrinkbaarheid-1" value="3">Raisonnable
                                <br><input type="radio" name="doordrinkbaarheid" id="doordrinkbaarheid-2" value="1">Modéré
                                <br><input type="radio" name="doordrinkbaarheid" id="doordrinkbaarheid-3" value="0">Mauvais
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="memberTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
                            <div class="panel-body">
                                <br><input type="radio" name="balans" id="balans-0" value="5" required>Bon
                                <br><input type="radio" name="balans" id="balans-1" value="3">Raisonnable
                                <br><input type="radio" name="balans" id="balans-2" value="1">Modéré
                                <br><input type="radio" name="balans" id="balans-3" value="0">Mauvais
                            ...
                            <div class="panel-body">
                                <div class="input-group">
                                    <table id="table">
                                        ...
                                        <tr>
                                            <td class="criteria">Acide carbonique</td>
                                        ...
                                        <tr>
                                            <td class="criteria">Métallique</td>
                                        ...
                                        <tr>
                                            <td class="criteria">Adhérence / résidu en bouche</td>
                                        ...
                                        <tr>
                                            <td class="criteria">Contractable / âpre</td>
                            ...
                            <div class="panel-body">
                                <div class="input-group">
                                    <table id="table">
                                        ...
                                        <tr>
                                            <td class="criteria">Alcool (chauffant)</td>
                                        ...
                                        <tr>
                                            <td class="criteria">Amer / houblonné</td>
                                        ...
                                        <tr>
                                            <td class="criteria">De type caramel</td>
                                        ...
                                        <tr>
                                            <td class="criteria">De type réglisse</td>
                                        ...
                                        <tr>
                                            <td class="criteria">De type levure</td>
                                        ...
                                        <tr>
                                            <td class="criteria">Medicinale</td>
                                        ...
                                        <tr>
                                            <td class="criteria">Douce / malté</td>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="memberSix" class="panel-collapse collapse" aria-labelledby="headingSix">
                            <div class="panel-body">
                                <br><input type="radio" name="creativiteit" id="creativiteit-0" value="5" required>Bon
                                <br><input type="radio" name="creativiteit" id="creativiteit-1" value="3">Raisonnable
                                <br><input type="radio" name="creativiteit" id="creativiteit-2" value="1">Modéré
                                <br><input type="radio" name="creativiteit" id="creativiteit-3" value="0">Mauvais
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="memberSeven" class="panel-collapse collapse" aria-labelledby="headingSeven">
                            <div class="panel-body">
                                <br><input type="radio" name="complexiteit" id="complexiteit-0" value="5" required>Bon
                                <br><input type="radio" name="complexiteit" id="complexiteit-1" value="3">Raisonnable
                                <br><input type="radio" name="complexiteit" id="complexiteit-2" value="1">Modéré
                                <br><input type="radio" name="complexiteit" id="complexiteit-3" value="0">Mauvais
                        ...
                        <div class="panel-heading" role="tab" id="headingEight">
                            <h4 class="panel-title">
                                <a class = "accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#memberEight" aria-expanded="false" aria-controls="memberEight">
                                    Réponds à type donné
                                </a>
                            </h4>
                        </div>
                        <div id="memberEight" class="panel-collapse collapse" aria-labelledby="headingEight">
                            <div class="panel-body">
                                <br><input type="radio" name="type" id="type-0" value="5" required>Bon
                                <br><input type="radio" name="type" id="type-1" value="3">Raisonnable
                                <br><input type="radio" name="type" id="type-2" value="1">Modéré
                                <br><input type="radio" name="type" id="type-3" value="0">Mauvais
                    ...
                    <div id="dienIn">
                        <input type="submit" value="Fichiez!" class="btn btn-primary"/>
                    </div>
                </div>
            </div>
        </form>
