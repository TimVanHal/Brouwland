...
<html>
    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../nl/logout.php" class="language">NL</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form>
            ...
            <div class="panel-heading">You are logged out.<br>You will be returned to the log-in page in a moment.</div>
        </form>
        <script>
