        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <ul id="opties">
                    ...
                    <li><a href="assignJudge.php">Assign judge to beer.</a></li>
                    <li><a href="editUser.php">Edit user information.</a></li>
                    <li><a href="removeUser.php">Remove user.</a></li>
                    <li><a href="deadlines.php">Set deadlines.</a></li>
                    <li><a href="coursedate.php">Set course dates.</a></li>
                </ul>
            </div>
        </div>
    </body>
