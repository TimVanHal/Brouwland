    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../fr/evaluationsFini.php" class="language">FR</a></div>
                            <div class="item"><a href="../../nl/beoordelingAfgelopen.php" class="language">NL</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form>
            <div class="panel panel-default">
                <div class="panel-heading">The evaluation period is over.</div>
                <div class="panel-body">
                    We're sorry, but the period to submit your evaluations has expired.
                </div>
            </div>
        </form>
    </body>
