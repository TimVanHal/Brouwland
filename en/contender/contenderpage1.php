            ...
            <div class="panel-heading">Team members</div>
                <div class="panel-body">
                            ...
                            <div class="panel-body">
                                ...
                                <br><label>Address: </label> 
                                    ...
                                    <div class="form-inline" id="editAdresReserve" style="display:none">
                                        <div class="form-group col-xs-9">
                                            <input type="text" class="form-control" id="newStraatReserve" placeholder="Street" name="straat2">
                                        </div>
                                        <div class="form-group col-xs-3">
                    ...
                    <div id="voegToe" style="display:none">
                        <button type="button" onclick="location.href='/en/deelnemer/newMember.php'">Click here to add a member.</button>
                    </div>
                    <?php
                        ...
                        <div id="password" class="panel-collapse collapse" aria-labelledby="headingNine">
                            <div class="panel-body">
                                ...
                                <div class="input-group col-xs-2">
                                    <input name="paswoord1" id="accPassword" type="password" class="form-control" placeholder="Password">
                                ...
                                <div class="input-group col-xs-2">
                                    <input name="paswoord2" id="newPassword" type="password" class="form-control" placeholder="Password">
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-eye-open"></span></span>
                                    <script>
                                        $(".glyphicon-eye-open").on("click", function() {
