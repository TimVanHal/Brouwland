...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="#">Contender index</a></li>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">Index contenders</div>
            <div class="panel-body">
                What do you want to do?
                <ul id="opties">
                    <li><a href="contenderpage1.php">Consult/edit information about team members.</a></li>
                    <li><a href="contenderpage2.php">Consult/edit information about the team and the beer.</a></li>
                    <li><?php
                        $url = resultaat();
                        echo "<a href='" . $url . "'>Download your result here</a>";
                    ?></li>
                    
                    The deadline for delivering your beer is: 
                    <?php
