    ...
    <body>
        ...
        <form method="POST" name="inschrijven1">
            <div class="panel panel-default">
                <div class="panel-heading">Information team and beer:</div>
                <div class="panel-body">
                    <div class="form-group">
                        <div class="input-group col-xs-2">
                            <label for="teamName">Teamname:</label>
                            <input id="teamName" name="teamNaam" type="text" class="form-control" placeholder="Teamname" required>
                        </div>
                        <div class="input-group col-xs-2">
                            <label>Country:</label>
                        ...
                        <div class="input-group col-xs-2">
                            ...
                            <input id="beerName" name="bierNaam" type="text" class="form-control" placeholder="Name of beer" required>
                        </div>
                        <div class="input-group col-xs-2">
