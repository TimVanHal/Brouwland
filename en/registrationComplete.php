...
<html>
    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../nl/inschrijvingCompleet.php" class="language">NL</a></div>
                            <div class="item"><a href="../fr/enregistrementComplete.php" class="language">FR</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form>
            ...
            <div class="panel-heading">You have registered to the competition<br>You will be returned to the log-in page in a moment.</div>
        </form>
        <script>
