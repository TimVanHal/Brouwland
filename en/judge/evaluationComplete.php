...
<html>
    ...
    <body>
        ...
        <div id="wrap">
            <div id="main">
                <div class="container_16">
                    <div class="grid_16">
                        <header><a href="#">
                                <div class="logo">Brouwland Beer Competition</div>
                            </a></header>
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../../fr/jure/evaluerComplete.php" class="language">FR</a></div>
                            <div class="item"><a href="../../nl/keurder/beoordelingCompleet.php" class="language">NL</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form>
            ...
            <div class="panel-heading">You have filled in everything.<br>You will be returned to the choice of beers in one moment.</div>
        </form>
        <script>
            var delay = 5000; //Your delay in milliseconds

            setTimeout(function(){ window.location = 'evaluation0.php'; }, delay);
        </script>
    </body>
</html>