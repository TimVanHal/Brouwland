                        ...
                        <div id="memberOne" class="panel-collapse collapse" aria-labelledby="headingOne">
                            <div class="panel-body">
                                ...
                                <div class="input-group" id="checkBoxes">
                                    <br><input onClick="calcPoints()" type="checkbox" name="presentatieFles" id="presentatie-1" value="1" disabled>Incorrect: Bottle
                                    <br><input type="checkbox" name="presentatieVulhoogte" onClick="calcPoints()" id="presentatie-2" value="1" disabled>Incorrect: Filling height
                                    <br><input type="checkbox" name="presentatieUiterlijk" onClick="calcPoints()" id="presentatie-3" value="1" disabled>Incorrect: External features
                                </div>
