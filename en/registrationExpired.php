    ...
    <body>
                ...
                <div class="container_16">
                    <div class="grid_16">
                        ...
                        <div id="topbox">
                            ...
                            <div class="item"><a href="../nl/inschrijvingAfgelopoen.php" class="language">NL</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <form>
            <div class="panel panel-default">
                <div class="panel-heading">The registration period has expired.</div>
                <div class="panel-body">
                    We're sorry, but he period for registration has expired. You can enter your details <a href="http://mijnbier.be/inscription/nextedition?lang=nl">here</a> to be notified when the next edition starts.
                </div>
            </div>
        </form>
    </body>
